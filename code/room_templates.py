"""Holds a handcrafted set of room templates for the prototype."""

from models import PortTemplate, RoomTemplate, RoomKind
from geometry import Direction

prototype_room_templates = [
	RoomTemplate(
		...
		kinds=frozenset((RoomKind.ROOT, RoomKind.FIRST_ROOT, RoomKind.DIRECT_LINKED, RoomKind.FOUR_WAY, RoomKind.T_JUNCTION, RoomKind.BEND, RoomKind.THROUGH)),
	),
	RoomTemplate(
		...
		first_root_weight=1.5,
		direct_linked_weight=1.5,
		kinds=frozenset((RoomKind.ROOT, RoomKind.FIRST_ROOT, RoomKind.DIRECT_LINKED)),
	),
	RoomTemplate(
		...
		through_weight=1.2,
		kinds=frozenset((RoomKind.DIRECT_LINKED, RoomKind.THROUGH)),
	),
	RoomTemplate(
		name="room_6x6_90deg",
		size=(6, 6),
		...
		direct_linked_weight=1.5,
		kinds=frozenset((RoomKind.ROOT, RoomKind.DIRECT_LINKED, RoomKind.BEND)),
	),
	RoomTemplate(
		...
		direct_linked_weight=2,
		preferred_center_facing_dir=Direction.NORTH,
		kinds=frozenset((RoomKind.DIRECT_LINKED,)),
	),
	...
	RoomTemplate(
		...
		kinds=frozenset((RoomKind.T_JUNCTION,)),
		allow_door_overlaps=True,
	),
]
